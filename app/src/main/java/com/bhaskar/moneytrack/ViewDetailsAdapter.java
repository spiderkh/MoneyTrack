                                                                    ...
                                                                    epicDialog.dismiss();
                                                                                                /*databaseReference22.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        {
                                                                                                            Log.d(TAG,"key in delet= "+dataSnapshot6.getKey());
                                                                                                            if(dataSnapshot6.getKey().equals(ukid[0]))
                                                                                                            {
                                                                                                                Log.d(TAG,"key in deletc inside if = "+dataSnapshot6.getKey());
                                                                                                                databaseReference22.child(dataSnapshot6.getKey()).setValue(null);
                                                                                                            }
...
/*
                                                                                    ...
                                                                                    if(i==0)
                                                                                    {
                                                                                        ...
                                                                                        Log.d(TAG, "comment[0]" + comment[0]);
                                                                                        input2.setText(comment[0]);

                                                                                        input2.setHint("Status");
                                                                                        input2.setInputType(InputType.TYPE_CLASS_TEXT);
                                                                                        Log.d(TAG, "stat[0] " + stat[0]);
                                                                                        input3.setText(stat[0]);
                                                                                        ...
                                                                                        final AlertDialog builder1 = new AlertDialog.Builder(context)
                                                                                                .setTitle("Update Details")
                                                                                                .setCancelable(false)
                                                                                                .setMessage("Please Enter the value Again").setView(linearLayout)
                                                                                        ...
                                                                                        (builder1).getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                                                                                            ...
                                                                                            public void onClick(View v) {
                                                                                                ...
                                                                                                Toast.makeText(context, "Yes", Toast.LENGTH_SHORT).show();
                                                                                                DatabaseReference databaseReference1=FirebaseDatabase.getInstance().getReference().child("test").child("users").child("expenses").child(pi.getGroupCode()).child(mm).child(md).child(uk);
                                                                                                //actual db DatabaseReference databaseReference1=FirebaseDatabase.getInstance().getReference().child("users").child("expenses").child(pi.getGroupCode()).child(mm).child(md).child(ukid).child("status");
                                                                                                databaseReference1.child("status").setValue(input3.getText().toString());
                                                                                                databaseReference1.child("comment").setValue(input2.getText().toString());
                                                                                                databaseReference1.child("amount").setValue( Double.parseDouble(input1.getText().toString()));
                                                        ...
                                                        /* getAllViewDetailsForEdit(ukid);*/
                                                        //test Id
                                                        // DatabaseReference databaseReference1=FirebaseDatabase.getInstance().getReference().child("test").child("users").child("expenses").child(pi.getGroupCode()).child(mm).child(md).child(ukid).child("status");
                                                        //actual db DatabaseReference databaseReference1=FirebaseDatabase.getInstance().getReference().child("users").child("expenses").child(pi.getGroupCode()).child(mm).child(md).child(ukid).child("status");
